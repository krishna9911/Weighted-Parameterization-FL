...
"""
divide_without_label()

You provide the x_train and y_train, and part into which the whole dataset should be distributed.
For example, if you have 1000 datasets and your part is 10, it will divide the whole data into 10
parts. Each part of the data can be fed into the individual clients. Generally, we take value of part
according to the number of clients we have.
